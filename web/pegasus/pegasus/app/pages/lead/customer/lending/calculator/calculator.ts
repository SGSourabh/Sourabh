...
export class CalculatorPage implements OnInit {
   ...
   this.navController.push(ProductPage ,{selection:this.pageCheck});
  }
}
...
export class Lending {
    ...
    safeSelectedCollateralTerm(): number {
        return Math.max(this.selectedCollateral ? 12 * this.selectedCollateral.term(this.safeLoanAmount(), this.ownersAge, this.loanDate.getFullYear(), this.manufactured) : this.selectedLendingPackage.maxLoanTerm, this.selectedLendingPackage.maxLoanTerm);
    }
