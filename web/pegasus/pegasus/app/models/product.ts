        ...
        salesGroups: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        description: '- Hưởng lãi suất từ quỹ liên kết chung - Hưởng các khoản thưởng duy trì hđ hấp dẫn từ năm hợp đồng thứ 10, trị giá tới 150% phí bh cơ bản 1 năm - Dược cam kết mức lãi suất đảm bảo**',
                        icon: 'bft_shield.svg'
                    },
                    {
